...
// PDF Translate data schema
export const PDFTranslateDataSchema = z.object({
  status: z.enum(['idle', 'translating', 'completed', 'error']).optional(),
  progress: z.number().optional(),
  currentPage: z.number().optional(),
  totalPages: z.number().optional(),
  sourceFilePath: z.string().optional(),
  sourceFileName: z.string().optional(),
  langOut: z.string().optional(),
  outputType: z.enum(['mono', 'dual', 'both']).optional(),
  translatedMonoPath: z.string().optional(),
  translatedDualPath: z.string().optional(),
  model: z.string().optional(),
...
export type PDFTranslateData = z.infer<typeof PDFTranslateDataSchema>

// Session schemas
export const SessionTypeSchema = z.enum(['chat', 'picture', 'pdf-translate'])
...
export const SessionSchema = z.object({
  ...
  compactionPoints: z.array(CompactionPointSchema).optional(),
  pdfData: PDFTranslateDataSchema.optional(),
})
