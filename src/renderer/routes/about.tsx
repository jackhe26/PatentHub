        ...
        <Stack gap="xxl" px={isSmallScreen ? 'sm' : 'md'} py={isSmallScreen ? 'xl' : 'md'}>
          <Flex gap="xxl" p="md" className="rounded-lg bg-chatbox-background-secondary">
            ...
            <Stack flex={1} gap="xxs">
              <Flex justify="space-between" align="center" wrap="wrap" gap={isSmallScreen ? 'xs' : 'sm'} rowGap="xs">
                <Title order={5} lh={1.5} lineClamp={1} title={`PatentHub v${version.version}`}>
                  PatentHub {/\d/.test(version.version) ? `(v${version.version})` : ''}
                </Title>
          ...
          <List>
            <ListItem
              ...
              title={t('Github')}
              link="https://github.com/jackhe2026"
              value="jackhe2026"
            />
            <ListItem
              icon={<BrandRedNote className="w-full h-full" />}
              title={t('RedNote')}
              link="https://www.xiaohongshu.com/user/profile/ jackhe2026"
              value="jackhe2026"
            />
          ...
          <List>
            ...
            <ListItem
              ...
              title={t('E-mail')}
              link={`mailto:heyuan188@126.com`}
              value="heyuan188@126.com"
            />
            <ListItem
