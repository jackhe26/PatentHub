    ...
    <Stack p="md" gap="xl">
      ...
      <Stack gap="xs">
        ...
        <Text c="chatbox-tertiary" size="xs">
          {t('PatentHub will use this model as the default for new chats.')}
        </Text>
      </Stack>
      ...
      <Stack gap="xs">
        ...
        <Text c="chatbox-tertiary" size="xs">
          {t('PatentHub will automatically use this model to rename threads.')}
        </Text>
      </Stack>
      ...
      <Stack gap="xs">
        ...
        <Text c="chatbox-tertiary" size="xs">
          {t('PatentHub will automatically use this model to construct search term.')}
        </Text>
      </Stack>
      <Stack gap="xs">
        ...
        <Text c="chatbox-tertiary" size="xs">
          {t('PatentHub OCRs images with this model and sends the text to models without image support.')}
        </Text>
      </Stack>
    </Stack>
  )
